...
scoreboard players operation @e[tag=path_marker,tag=init,limit=1] path = markers path
title @s actionbar [{"text":"Path marker set (","color":"aqua","bold":true},{"score":{"objective":"path","name":"markers"},"color":"aqua","bold":true},{"text":")","color":"aqua","bold":true}]

scoreboard players add markers path 1
