...
=======
execute as @a[gamemode=creative,tag=!disable_path,scores={path_click=1..},nbt={SelectedItem:{tag:{pathPlace:1b}}}] at @s run function path:place
execute as @a[gamemode=creative,tag=!disable_path,scores={path_click=1..},nbt={SelectedItem:{tag:{pathStart:1b}}}] if score markers path matches 2.. at @s run function path:init
execute as @a[gamemode=creative,tag=!disable_path,scores={path_click=1..},nbt={SelectedItem:{tag:{pathClear:1b}}}] at @s run function path:clear
>>>>>>> 368152de1127a3e9741a0c2e1795b154ad2d7f90
...
=======
execute if entity @a[gamemode=creative,tag=!disable_path,nbt={SelectedItem:{tag:{pathPlace:1b}}}] if score markers path matches 2.. unless entity @e[type=llama,tag=path] run function path:show_path
>>>>>>> 368152de1127a3e9741a0c2e1795b154ad2d7f90
